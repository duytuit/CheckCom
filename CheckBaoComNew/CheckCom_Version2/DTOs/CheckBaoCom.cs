...
namespace CheckCom_Version2.DTOs
{
    public class CheckBaoCom
    {
        ...
        public int kieudoan { get; set; }
        public string buaanid { get; set; }
        public string buaan { get; set; }
        public int ca { get; set; }
        public string nhaanid { get; set; }
        public string nhaan { get; set; }
        public int loaidouong { get; set; }
        public int thanhtoan { get; set; }
        public int phongrieng { get; set; }
        public string dangkybosung { get; set; }
        public string bepanid { get; set; }
    }
}
